...
_Python main file of game utilizing the pygame library_

## Gampeplay Photo

![Desktop View](/assets/img/MetroidInvasion/GameplayPhoto.png){: width="972" height="589" }
_Gameplay photos. Health bar on (top left), high score (top middle), score and level (top right)_
